# FIXME: this file is a copy of pytorch's _utils.py. Merge back to pytorch when the patch is merged.
# this is to support the custom copy of pytorch's serialization.py
# in pytorch's serialization.py, added (lines 1535-1538):
#    try:
#       del torch._utils._thread_local_state.map_location
#    except:
#       pass
# to avoid the following AttributeError:
#   AttributeError: module 'torch._utils.thread_local_state' has no attribute 'map_location'
