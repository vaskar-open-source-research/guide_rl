...
from verl.utils.reward_score.prime_code.utils import check_correctness as apps_check_correctness
import json
import re
import traceback
...
if __name__ == "__main__":
    print(compute_score("```python\nprint('Kobe')```", {"inputs": ["Hello, world!"], "outputs": ["Hello, world!"]}, continuous=True))
